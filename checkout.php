...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="Satara" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>State:</span>
         ...
         <div class="inputBox">
            <span>Country :</span>
            <input type="text" name="country" placeholder="Saudi Arabia" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>ZIP CODE :</span>
